  ...
  const split = "Split";
    ...
    switch (aces) {
      case 0:
        ...
        if ((pValue === 12 && dValue === 2) || (pValue === 12 && dValue === 3))
          return { message: hit };
        if (pValue === 12 && dValue > 3 && dValue < 7)
      ...
      case 1:
        ...
        if (pValue === 19 && dValue > 1 && dValue < 6)
          return { message: stand };
        if (pValue === 19 && dValue === 6) return { message: double };
        if (pValue === 19 && dValue > 6 && dValue < 12)
          return { message: stand };
        ...
        if (pValue === 17 && dValue > 2 && dValue < 7)
          return { message: double };
        if (
          (pValue === 17 && dValue > 6) ||
          (pValue === 16 && dValue > 6) ||
